...
class ResHarmonicsService {
  ...
  // Contact creation method - enhanced to create finance account simultaneously
  async createContact(contactData) {
    const contactPayload = {
      ...
      // CREATE FINANCE ACCOUNT AT THE SAME TIME AS CONTACT
      contactSalesAccount: {
        contact: {
          firstName: contactData.firstName,
          lastName: contactData.lastName
          // id will be set by ResHarmonics when contact is created
        }
        // accountCode will be auto-generated by ResHarmonics
        // company is optional (null for individual guests)
      }
    };
    ...
    console.log('Creating contact WITH finance account:', JSON.stringify(contactPayload, null, 2));
